 ...
 */
$config['site_title']                 = "Stara.id";          // Site Title, example.com
$config['admin_email']                = "cs@stara.id";       // Admin Email, admin@example.com
 ...
 */
$config['remember_cookie_name'] = 'sassRC';
$config['identity_cookie_name'] = 'sassIC';
